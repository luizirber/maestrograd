...
"13:9,12:2,13,12:2,13:18,12,13:15,10:10,13:3,3,13:3,11:3,7,11:4,8,11:4,6,11," +
"4,11,5,11:4,9,11:3,1,13,2,13:3,11:26,13:5,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,15,
"0,1:14")[0];

	private int yy_nxt[][] = unpackFromString(2,14,
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -10:
						break;
					case 10:
						{ return new Symbol(sym.ENQUANTO); }
					case -11:
						break;
					case 11:
						{ return new Symbol(sym.NUMERO, new Character(yytext().charAt(0))); }
					case -12:
						break;
					case 12:
						{ return new Symbol(sym.LETRA, new Character(yytext().charAt(0))); }
					case -13:
						break;
					case 13:
						{ /* ignore white space. */ }
